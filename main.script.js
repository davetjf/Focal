...
(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    Sa.innerHTML =
      '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Color Blind Mode</div>\n          <div class="description">High contrast colors</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback</div>\n        </div>\n        <div class="control">\n          <a href="mailto:davetjf@gmail.com?subject=Feedback">Email</a>\n          |\n          <a href="https://github.com/davetjf/Focal" target="blank" >GitHub</a>\n        </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div id="copyright">Copyright le Josh Wardle 2021-2022. Rinne sé seo!!! All Rights Reserved.</div>\n    <div>\n      <div id="puzzle-number"></div>\n      <div id="hash"></div>\n    </div>\n  </div>\n';
    var _a = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
    ...
    var Ba = "abcdefghijklmnopqrstuvwxyzáíóúé",
                ...
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                  ...
                  if (((e = s), !Ta.includes(e) && !La.includes(e)))
                    return (
                      ...
                      void this.addToast("Nach bhfuil i liosta focal")
                    );
                  if (this.hardMode) {
              ...
              value: function () {
                ...
                this.$game.addEventListener("game-key-press", function (a) {
                  ...
                  this.shadowRoot
                    ...
                    .addEventListener("click", function (a) {
                      var s = e.$game.querySelector("game-page"),
                        t = document.createTextNode("Conas a Imirt");
                      s.appendChild(t);
    ...
    var Is = document.createElement("template");
    Is.innerHTML =
      '\n  <div class="countdown">\n    <h1>An chéad fhocal eile</h1>\n    <div id="timer">\n      <div class="statistic-container">\n        <div class="statistic timer">\n          <countdown-timer></countdown-timer>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class="share">\n    <button id="share-button">\n      Sciar <game-icon icon="share"></game-icon>\n    </button>\n  </div>\n';
    var Ms = {
        currentStreak: "Stráice Reatha",
        maxStreak: "Stráice Uasta",
        winPercentage: "Bua %",
        gamesPlayed: "Cluichí Imeartha",
        gamesWon: "Cluichí a bhuaigh",
        averageGuesses: "buille faoi thuairim meán",
      },
      Os = (function (e) {
        r(t, e);
        var a = h(t);
    ...
    Ps.innerHTML =
      '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Buille faoi thuairim an <strong>Focal</strong> i 6 iarracht.</p>\n      <p>Caithfidh gach buille faoi thuairim a bheith ina fhocal bailí 5 litir. Buail an cnaipe isteach chun é a chur isteach.</p>\n      <p>Tar éis gach buille faoi thuairim, athrófar dath na tíleanna chun a thaispeáint cé chomh gar agus a bhí do thuairim don fhocal.</p>\n      <div class="examples">\n        <p><strong>Samplaí</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="A" evaluation="correct" reveal></game-tile>\n            <game-tile letter="N"></game-tile>\n            <game-tile letter="S"></game-tile>\n            <game-tile letter="E"></game-tile>\n            <game-tile letter="O"></game-tile>\n          </div>\n          <p>Tá an litir <strong>A</strong> san fhocal agus sa spota ceart.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="C"></game-tile>\n            <game-tile letter="É" evaluation="present" reveal></game-tile>\n            <game-tile letter="I"></game-tile>\n            <game-tile letter="L"></game-tile>\n            <game-tile letter="E"></game-tile>\n          </div>\n          <p>Tá an litir <strong>É</strong> san fhocal ach sa spota mícheart.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="R"></game-tile>\n            <game-tile letter="Í"></game-tile>\n            <game-tile letter="T"></game-tile>\n            <game-tile letter="H" evaluation="absent" reveal></game-tile>\n            <game-tile letter="E"></game-tile>\n          </div>\n          <p>Níl an litir <strong>H</strong> san fhocal in aon láthair.</p>\n        </div>\n      </div>\n      <p><strong>Beidh Focal nua ann gach lá!<strong></p>\n   </div>\n      </div>\n      <p><strong>Josh Wordle a rinne an cluiche seo, agus is leis gach rud é. Arna aistriú ag David Fortune.<strong></p>\n  </div>\n  </section>\n';
    var Hs = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
